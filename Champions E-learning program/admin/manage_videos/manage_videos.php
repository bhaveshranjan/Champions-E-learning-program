...
$videos=new manage_videos_class;	
$video=$videos->display_videos();   
 ?>
...
.tab-card-header > .tab-content {
 ...
 <body onload="">
  ...
  <a class="navbar-brand text-white" href="#">Champions E-Learning Program</a>
...
<?php foreach ($video as $video_list)
 {
  ...
  <div class="card-body">
    <h5 class="card-title"><?php echo $video_list['course_name']; ?> <a href="edit_videos.php?course_name=<?php echo $video_list['course_name']; ?>" class="h6 text-info float-right">Add videos <i class="fa fa-pencil ml-1"></i></a></h5>
