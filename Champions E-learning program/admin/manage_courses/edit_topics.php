...
<?php
 ...
 <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="admin/manage_quiz/manage_quiz.php">Manage Quize</a></li>
            <li class="list-group-item bg-dark"><a href="admin/manage_videos/manage_videos.php">Manage Videos</a></li>
