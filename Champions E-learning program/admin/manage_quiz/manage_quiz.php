      ...
      <div class="row">
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="manage_quiz.php">Manage Quiz</a></li>
            ...
            <div class="card-body col-md-12">
				  ...
				  <form action="quiz_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
					    <div class="form-group">
					      ...
					      <input type="text" class="form-control" id="c_name" placeholder="Enter Subject Name" name="course_name1">
