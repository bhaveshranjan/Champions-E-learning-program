jQuery(document).ready(function()
{
	...
	var typed = new Typed(".text", {
	  strings:["hello world ","<strong class='primary'>welcome to Champions E-Learning Program</strong>","you are at right place","Keep learning, <strong class='primary'>Keep Growing</strong>"],
